...
exports.XLMPrice= function(key, cb) {
    ...
    code.getJSON('https://api.gdax.com/products/XLM-USD/ticker', function(err, json){
        if(err){
            console.error(err);
        }
        json = JSON.parse(json);
...
exports.LINKPrice= function(key, cb) {
    ...
    code.getJSON('https://api.gdax.com/products/LINK-USD/ticker', function(err, json){
        if(err){
            console.error(err);
        }
        json = JSON.parse(json);
...
exports.XTZPrice= function(key, cb) {
    ...
    code.getJSON('https://api.gdax.com/products/XTZ-USD/ticker', function(err, json){
        if(err){
            console.error(err);
        }
        json = JSON.parse(json);
